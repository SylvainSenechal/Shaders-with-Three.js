...
void main()
{
    vec4 sample0 = texture2D(tDiffuse, vUv / iResolution.xy);
...
const render = () => {
    ...
    directionalLight.position.x += Math.cos(angXsun) * amplitude
  	directionalLight.position.y += Math.sin(angYsun) * amplitude
